...
namespace G2D {
    ...
    void
    DrawStringFontRoman(V2 pos, std::string text, float fontSize = 20, float thickness = 3, Color c = Color::Black);

    // Cr�e une texture � partir d'une description 1 lettre = 1 couleur / voir exemple
